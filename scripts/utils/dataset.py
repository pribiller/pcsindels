...
class Dataset:
	...
	def __init__(self):
		...
		self.computationalResources_estimateEvolTimes = {"panPan3": CompRes("08:00:00", 50, 0.00),"panTro6": CompRes("08:00:00", 50, 0.00),"gorGor6": CompRes("08:00:00", 50, 0.00),"ponAbe3": CompRes("08:00:00", 50, 0.00),"papAnu4": CompRes("08:00:00", 50, 0.00),"macFas5": CompRes("08:00:00", 50, 0.00),"rhiRox1": CompRes("08:00:00", 50, 0.00),"chlSab2": CompRes("08:00:00", 50, 0.00),"nasLar1": CompRes("08:00:00", 50, 0.00),"rheMac10": CompRes("08:00:00", 50, 0.00),"calJac4": CompRes("08:00:00", 50, 0.00),"tarSyr2": CompRes("08:00:00", 50, 0.00),"micMur2": CompRes("08:00:00", 50, 0.00),"galVar1": CompRes("08:00:00", 50, 0.00),"mm39": CompRes("08:00:00", 50, 0.00),"oryCun2": CompRes("08:00:00", 50, 0.00),"rn7": CompRes("08:00:00", 50, 0.00),"vicPac2": CompRes("08:00:00", 50, 0.00),"bisBis1": CompRes("08:00:00", 50, 0.00),"felCat9": CompRes("08:00:00", 50, 0.00),"manPen1": CompRes("08:00:00", 50, 0.00),"bosTau9": CompRes("08:00:00", 50, 0.00),"canFam6": CompRes("08:00:00", 50, 0.00),"musFur1": CompRes("08:00:00", 50, 0.00),"neoSch1": CompRes("08:00:00", 50, 0.00),"equCab3": CompRes("08:00:00", 50, 0.00),"myoLuc2": CompRes("08:00:00", 50, 0.00),"susScr11": CompRes("08:00:00", 50, 0.00),"enhLutNer1": CompRes("08:00:00", 50, 0.00),"triMan1": CompRes("08:00:00", 50, 0.00),"macEug2": CompRes("08:00:00", 50, 0.00),"ornAna2": CompRes("08:00:00", 50, 0.00),"aptMan1": CompRes("08:00:00", 50, 0.00),"galGal6": CompRes("08:00:00", 50, 0.00),"thaSir1": CompRes("08:00:00", 50, 0.00),"aquChr2": CompRes("08:00:00", 50, 0.00),"melGal5": CompRes("08:00:00", 50, 0.00),"xenLae2": CompRes("08:00:00", 50, 0.00),"xenTro10": h,"danRer11": CompRes("08:00:00", 50, 0.00)}
	...
	def getCompRes_estimateEvolTimes(self,ucscName):
		return self.computationalResources_estimateEvolTime[ucscName]
	...
	def getOutFilenamePattern_estimateEvolTimes(self,ucscName,alpha):
		return os.path.join(self.dirSetupEvolTimes, f"evolTimes-ests.{ucscName}.*.alpha{float(alpha)}.*.pickle")

	def getOutFilename_estimateEvolTimes(self, ucscName, chrom, windowSizeRef, alpha):
		return os.path.join(self.dirEstEvolTimes, f"evolTimes-ests.{ucscName}.{chrom}.alpha{float(alpha)}.winSize{windowSizeRef}.pickle")
