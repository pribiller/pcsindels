...
| ▹6.2 | [Evolutionary time estimates comparison (Figure 3)](https://pribiller.github.io/pcsindels/6_2_plotFig_EvolTimesComp.html) | [6_2_plotFig_EvolTimesComp.py](https://github.com/pribiller/pcsindels/blob/main/scripts/6_2_plotFig_EvolTimesComp.py)  | < 1GB | 1 | < 2 minutes | 308 kB |
